...
import {
  applyWizard as applyWizardInternal,
...
export class OpenClawApp extends LitElement {
  ...
  // Studio wizard state
  @state() wizardStep: WizardStep = "identity";
  @state() wizardData: WizardData = createDefaultWizardData();
  ...
  handleWizardStepChange(step: WizardStep) {
    this.wizardStep = step;
  }

  handleWizardDataChange(patch: Partial<WizardData>) {
    this.wizardData = { ...this.wizardData, ...patch };
  }

  async handleWizardFinish() {
    await applyWizardInternal(this);
  }

  async handleDashboardRefresh() {
    await loadDashboardInternal(this);
  }
